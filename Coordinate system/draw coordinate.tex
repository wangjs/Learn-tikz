...
%    \FPround{\bOpt}{\bOpt}{2}
   ...
   % draw coordinate
    ...
    \foreach \kl/\P/\kb/\M in {#1/#2/#3/#4}{
        \draw[color=black, ultra thick] plot[id=#1#2#3#4a]% the domain of "plot function" is defined below when calling tikzpicture as a global defination at line 108
